...
.ranking_section .ranking_item .recommend_num+.Adoption_completed:before {
    /* content: ''; */
    display: inline-block;
    width: 1px;
    height: 12px;
 ...
 /* 답변수 색깔 */
.ranking_section .ranking_item .Adoption_completed {
    color: red;
     position: relative;
    right: -220px;
      bottom : -10px;
		...
		<div class="ranking_list_area" id="rankingChart">
				...
				<ul class="ranking_list">
					...
					<li class="ranking_item _item_3" >
						...
						<span class="recommend_num">조회수 1575</span><span class="reply_num">답변수 10</span><span class="Adoption_completed">채택완료</span>
					</li>
				...
				<ul class="ranking_list">
					...
					<li class="ranking_item _item_4" >
						...
						<span class="recommend_num">조회수 1413</span><span class="reply_num">답변수 8</span>
					</li>
					...
					<li class="ranking_item _item_5" >
						...
						<span class="recommend_num">조회수 1348</span><span class="reply_num">답변수 1</span><span class="Adoption_completed">채택완료</span>
					</li>
	...
	<div class="ranking_section">	
		...
		<div class="ranking_list_area" id="rankingChart">
				...
				<ul class="ranking_list">
					...
					<!-- 제목 -->	<a href="" class="ranking_title" target="_blank" onclick="">코로나 백신 접종 예약</a>
					<!-- 타이틀 -->	<a href="" class="text" target="_blank" onclick="">지금 50대부터 코로나 백신 접종 예약 진행중인것으로 아는데요 다음주에도 접종예정인지 궁금합니다. 부모...</a>
						<span class="recommend_num">조회수 4953</span><span class="reply_num">답변수 3</span> <span class="Adoption_completed">채택완료</span>
					</li>
				...
				<ul class="ranking_list">
					...
					<li class="ranking_item _item_6" >
						<span class="no"></span>
						<a href="" class="ranking_title" target="_blank" onclick=""></a>
						<a href="" class="text" target="_blank" onclick=""></a>
